...
rmarkdown::render("scripts/property_association/diversity.Rmd", 
    params = list(
        ...
        join = "columns",
        taxa = c("../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/LUAD/LUAD_selectedTumor_bacteria_species_merged_unamb_score_norm.txt"),
        cat_properties = c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", 
                              "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22"
                          ),
        values_not_considered = rep("unknown", 22),
...
rmarkdown::render("scripts/property_association/diversity.Rmd", 
    params = list(
        ...
        join = "columns",
        taxa = c("../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/LUSC/LUSC_selectedTumor_bacteria_species_merged_unamb_score_norm.txt"),
        cat_properties = c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", 
                              "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22"
                          ),
        values_not_considered = rep("unknown", 22),
...
rmarkdown::render("scripts/property_association/diversity.Rmd", 
    params = list(
        ...
        join = "columns",
        taxa = c("../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/HNSC/HNSC_selectedTumor_bacteria_species_merged_unamb_score_norm.txt"),
        cat_properties = c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", 
                              "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22"
                          ),
        values_not_considered = rep("unknown", 22),
...
rmarkdown::render("scripts/property_association/diversity.Rmd", 
    params = list(
        ...
        join = "columns",
        taxa = c("../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/OV/OV_selectedTumor_bacteria_species_merged_unamb_score_norm.txt"),
        cat_properties = c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", 
                              "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22"
                          ),
        values_not_considered = rep("unknown", 22),
...
rmarkdown::render("scripts/property_association/diversity.Rmd", 
    params = list(
        ...
        join = "columns",
        taxa = c("../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/READ/READ_selectedTumor_bacteria_species_merged_unamb_score_norm.txt"),
        cat_properties = c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", 
                              "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22"
                          ),
        values_not_considered = rep("unknown", 22),
...
rmarkdown::render("scripts/property_association/diversity.Rmd", 
    params = list(
        ...
        join = "columns",
        taxa = c("../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/SKCM/SKCM_selectedTumor_bacteria_species_merged_unamb_score_norm.txt"),
        cat_properties = c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", 
                              "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22"
                          ),
        values_not_considered = rep("unknown", 22),
