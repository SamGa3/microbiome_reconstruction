...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/GBM_selectedTumor_COX_OS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/GBM_selectedTumor_COX_DFS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    metadata = c("../../metadata/LUSC/LUSC_clinical_metadata.txt",
                  "../../results/property_association/bacteria_species/ComBat_batch_corrected_plate_id/merged_unamb_score_norm/LUSC/tables/LUSC_ComBat_corr_plate_id_selectedTumor_pca_tab.txt"),
    join = c("columns"),
    taxa = "../../data/RNAseq/bacteria/ComBat_plate_id/merged_unamb_score_norm/LUSC_ComBat_corr_plate_id_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/LUSC_selectedTumor_COX_OS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/LUSC_selectedTumor_COX_DFS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    metadata = c("../../metadata/HNSC/HNSC_clinical_metadata.txt",
                  "../../results/property_association/bacteria_species/ComBat_batch_corrected_plate_id/merged_unamb_score_norm/HNSC/tables/HNSC_ComBat_corr_plate_id_selectedTumor_pca_tab.txt"),
    join = c("columns"),
    taxa = "../../data/RNAseq/bacteria/ComBat_plate_id/merged_unamb_score_norm/HNSC_ComBat_corr_plate_id_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/HNSC_selectedTumor_COX_OS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/HNSC_selectedTumor_COX_DFS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    metadata = c("../../metadata/OV/OV_clinical_metadata.txt",
                  "../../results/property_association/bacteria_species/ComBat_batch_corrected_plate_id/merged_unamb_score_norm/OV/tables/OV_ComBat_corr_plate_id_selectedTumor_pca_tab.txt"),
    join = c("columns"),
    taxa = "../../data/RNAseq/bacteria/ComBat_plate_id/merged_unamb_score_norm/OV_ComBat_corr_plate_id_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/OV_selectedTumor_COX_OS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/OV_selectedTumor_COX_DFS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    metadata = c("../../metadata/SKCM/SKCM_clinical_metadata.txt",
                  "../../results/property_association/bacteria_species/ComBat_batch_corrected_plate_id/merged_unamb_score_norm/SKCM/tables/SKCM_ComBat_corr_plate_id_selectedTumor_pca_tab.txt"),
    join = c("columns"),
    taxa = "../../data/RNAseq/bacteria/ComBat_plate_id/merged_unamb_score_norm/SKCM_ComBat_corr_plate_id_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/SKCM_selectedTumor_COX_OS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/SKCM_selectedTumor_COX_DFS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    metadata = c("../../metadata/READ/READ_clinical_metadata.txt",
                  "../../results/property_association/bacteria_species/ComBat_batch_corrected_plate_id/merged_unamb_score_norm/READ/tables/READ_ComBat_corr_plate_id_selectedTumor_pca_tab.txt"),
    join = c("columns"),
    taxa = "../../data/RNAseq/bacteria/ComBat_plate_id/merged_unamb_score_norm/READ_ComBat_corr_plate_id_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/READ_selectedTumor_COX_OS_PC123456_"
  ), 
...
rmarkdown::render("scripts/survival_analysis/cox_analysis.Rmd", 
  params=list(
    ...
    numeric_covariates = c("PC1", "PC2", "PC3", "PC4", "PC5", "PC6"),
    timerange_cont = list(c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5), c(0, 5)),
    table_path = "../../results/survival_analysis/tables/READ_selectedTumor_COX_DFS_PC123456_"
  ), 
...
COAD_OS=read.csv("../../results/survival_analysis/tables/COAD_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
COAD_OS=data.frame(cancer_type=rep("COAD", nrow(COAD_OS)), surv=rep("OS", nrow(COAD_OS)), PCs=rownames(COAD_OS), COAD_OS)
COAD_DFS=read.csv("../../results/survival_analysis/tables/COAD_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
COAD_DFS=data.frame(cancer_type=rep("COAD", nrow(COAD_DFS)), surv=rep("DFS", nrow(COAD_OS)), PCs=rownames(COAD_DFS), COAD_DFS)

GBM_OS=read.csv("../../results/survival_analysis/tables/GBM_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
GBM_OS=data.frame(cancer_type=rep("GBM", nrow(GBM_OS)), surv=rep("OS", nrow(GBM_OS)), PCs=rownames(GBM_OS), GBM_OS)
GBM_DFS=read.csv("../../results/survival_analysis/tables/GBM_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
GBM_DFS=data.frame(cancer_type=rep("GBM", nrow(GBM_DFS)), surv=rep("DFS", nrow(GBM_OS)), PCs=rownames(GBM_DFS), GBM_DFS)

HNSC_OS=read.csv("../../results/survival_analysis/tables/HNSC_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
HNSC_OS=data.frame(cancer_type=rep("HNSC", nrow(HNSC_OS)), surv=rep("OS", nrow(HNSC_OS)), PCs=rownames(HNSC_OS), HNSC_OS)
HNSC_DFS=read.csv("../../results/survival_analysis/tables/HNSC_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
HNSC_DFS=data.frame(cancer_type=rep("HNSC", nrow(HNSC_DFS)), surv=rep("DFS", nrow(HNSC_OS)), PCs=rownames(HNSC_DFS), HNSC_DFS)

LUAD_OS=read.csv("../../results/survival_analysis/tables/LUAD_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
LUAD_OS=data.frame(cancer_type=rep("LUAD", nrow(LUAD_OS)), surv=rep("OS", nrow(LUAD_OS)), PCs=rownames(LUAD_OS), LUAD_OS)
LUAD_DFS=read.csv("../../results/survival_analysis/tables/LUAD_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
LUAD_DFS=data.frame(cancer_type=rep("LUAD", nrow(LUAD_DFS)), surv=rep("DFS", nrow(LUAD_OS)), PCs=rownames(LUAD_DFS), LUAD_DFS)

LUSC_OS=read.csv("../../results/survival_analysis/tables/LUSC_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
LUSC_OS=data.frame(cancer_type=rep("LUSC", nrow(LUSC_OS)), surv=rep("OS", nrow(LUSC_OS)), PCs=rownames(LUSC_OS), LUSC_OS)
LUSC_DFS=read.csv("../../results/survival_analysis/tables/LUSC_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
LUSC_DFS=data.frame(cancer_type=rep("LUSC", nrow(LUSC_DFS)), surv=rep("DFS", nrow(LUSC_OS)), PCs=rownames(LUSC_DFS), LUSC_DFS)

OV_OS=read.csv("../../results/survival_analysis/tables/OV_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
OV_OS=data.frame(cancer_type=rep("OV", nrow(OV_OS)), surv=rep("OS", nrow(OV_OS)), PCs=rownames(OV_OS), OV_OS)
OV_DFS=read.csv("../../results/survival_analysis/tables/OV_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
OV_DFS=data.frame(cancer_type=rep("OV", nrow(OV_DFS)), surv=rep("DFS", nrow(OV_OS)), PCs=rownames(OV_DFS), OV_DFS)

READ_OS=read.csv("../../results/survival_analysis/tables/READ_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
READ_OS=data.frame(cancer_type=rep("READ", nrow(READ_OS)), surv=rep("OS", nrow(READ_OS)), PCs=rownames(READ_OS), READ_OS)
READ_DFS=read.csv("../../results/survival_analysis/tables/READ_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
READ_DFS=data.frame(cancer_type=rep("READ", nrow(READ_DFS)), surv=rep("DFS", nrow(READ_OS)), PCs=rownames(READ_DFS), READ_DFS)

SKCM_OS=read.csv("../../results/survival_analysis/tables/SKCM_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
SKCM_OS=data.frame(cancer_type=rep("SKCM", nrow(SKCM_OS)), surv=rep("OS", nrow(SKCM_OS)), PCs=rownames(SKCM_OS), SKCM_OS)
SKCM_DFS=read.csv("../../results/survival_analysis/tables/SKCM_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
SKCM_DFS=data.frame(cancer_type=rep("SKCM", nrow(SKCM_DFS)), surv=rep("DFS", nrow(SKCM_OS)), PCs=rownames(SKCM_DFS), SKCM_DFS)

BRCA_OS=read.csv("../../results/survival_analysis/tables/BRCA_selectedTumor_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
BRCA_OS=data.frame(cancer_type=rep("BRCA", nrow(BRCA_OS)), surv=rep("OS", nrow(BRCA_OS)), PCs=rownames(BRCA_OS), BRCA_OS)
BRCA_DFS=read.csv("../../results/survival_analysis/tables/BRCA_selectedTumor_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
