...
GBM_OS=read.csv("../../results/survival_analysis/tables/GBM_OnlyPrimaryNoDupl_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
GBM_OS=data.frame(cancer_type=rep("GBM", nrow(GBM_OS)), surv=rep("OS", nrow(GBM_OS)), PCs=rownames(GBM_OS), GBM_OS)
GBM_DFS=read.csv("../../results/survival_analysis/tables/GBM_OnlyPrimaryNoDupl_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
GBM_DFS=data.frame(cancer_type=rep("GBM", nrow(GBM_DFS)), surv=rep("DFS", nrow(GBM_OS)), PCs=rownames(GBM_DFS), GBM_DFS)

HNSC_OS=read.csv("../../results/survival_analysis/tables/HNSC_noFFPEOnlyPrimary_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
HNSC_OS=data.frame(cancer_type=rep("HNSC", nrow(HNSC_OS)), surv=rep("OS", nrow(HNSC_OS)), PCs=rownames(HNSC_OS), HNSC_OS)
HNSC_DFS=read.csv("../../results/survival_analysis/tables/HNSC_noFFPEOnlyPrimary_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
...
LUSC_OS=read.csv("../../results/survival_analysis/tables/LUSC_OnlyPrimaryNoDupl_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
LUSC_OS=data.frame(cancer_type=rep("LUSC", nrow(LUSC_OS)), surv=rep("OS", nrow(LUSC_OS)), PCs=rownames(LUSC_OS), LUSC_OS)
LUSC_DFS=read.csv("../../results/survival_analysis/tables/LUSC_OnlyPrimaryNoDupl_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
LUSC_DFS=data.frame(cancer_type=rep("LUSC", nrow(LUSC_DFS)), surv=rep("DFS", nrow(LUSC_OS)), PCs=rownames(LUSC_DFS), LUSC_DFS)

OV_OS=read.csv("../../results/survival_analysis/tables/OV_OnlyPrimaryNomirVana_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
OV_OS=data.frame(cancer_type=rep("OV", nrow(OV_OS)), surv=rep("OS", nrow(OV_OS)), PCs=rownames(OV_OS), OV_OS)
OV_DFS=read.csv("../../results/survival_analysis/tables/OV_OnlyPrimaryNomirVana_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
OV_DFS=data.frame(cancer_type=rep("OV", nrow(OV_DFS)), surv=rep("DFS", nrow(OV_OS)), PCs=rownames(OV_DFS), OV_DFS)

READ_OS=read.csv("../../results/survival_analysis/tables/READ_OnlyPrimary_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
READ_OS=data.frame(cancer_type=rep("READ", nrow(READ_OS)), surv=rep("OS", nrow(READ_OS)), PCs=rownames(READ_OS), READ_OS)
READ_DFS=read.csv("../../results/survival_analysis/tables/READ_OnlyPrimary_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
READ_DFS=data.frame(cancer_type=rep("READ", nrow(READ_DFS)), surv=rep("DFS", nrow(READ_OS)), PCs=rownames(READ_DFS), READ_DFS)

SKCM_OS=read.csv("../../results/survival_analysis/tables/SKCM_OnlyPrimary_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
SKCM_OS=data.frame(cancer_type=rep("SKCM", nrow(SKCM_OS)), surv=rep("OS", nrow(SKCM_OS)), PCs=rownames(SKCM_OS), SKCM_OS)
SKCM_DFS=read.csv("../../results/survival_analysis/tables/SKCM_OnlyPrimary_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
SKCM_DFS=data.frame(cancer_type=rep("SKCM", nrow(SKCM_DFS)), surv=rep("DFS", nrow(SKCM_OS)), PCs=rownames(SKCM_DFS), SKCM_DFS)

BRCA_OS=read.csv("../../results/survival_analysis/tables/BRCA_OnlyPrimary_COX_OS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
BRCA_OS=data.frame(cancer_type=rep("BRCA", nrow(BRCA_OS)), surv=rep("OS", nrow(BRCA_OS)), PCs=rownames(BRCA_OS), BRCA_OS)
BRCA_DFS=read.csv("../../results/survival_analysis/tables/BRCA_OnlyPrimary_COX_DFS_PC123456_univ.txt", sep="\t", header=TRUE, check.names=FALSE, stringsAsFactors=FALSE)
