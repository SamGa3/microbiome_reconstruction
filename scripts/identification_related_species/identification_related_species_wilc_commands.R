...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../data/RNAseq/bacteria/raw/merged_unamb_score_norm/COAD/COAD_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "bmi", "stage", "CMS", "history_of_other_malignancy", "side", "MSI_status", "CIMP_status", 
                    "history_colon_polyps"),
  values_not_considered = list("unknown", "unknown", "unknown", "unknown", c("unknown","inconsistency"), "unknown", 
                                "unknown", "unknown", "unknown"),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_COAD.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/GBM/GBM_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "MSI_status"),
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/LUAD/LUAD_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "stage", "history_of_other_malignancy", "MSI_status"),
  values_not_considered = list("unknown", "unknown", c("unknown","inconsistency"), "unknown"),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_LUAD.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/LUSC/LUSC_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "stage", "MSI_status"),
  values_not_considered = list("unknown", "unknown", "unknown"),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_LUSC.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/HNSC/HNSC_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "stage", "history_of_other_malignancy", "MSI_status"),
  values_not_considered = list("unknown", "unknown", c("unknown","inconsistency"), "unknown"),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_HNSC.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/OV/OV_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("stage", "MSI_status"),
  values_not_considered = list("unknown", "unknown"),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_OV.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/READ/READ_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "bmi", "stage", "CMS", "history_of_other_malignancy", "MSI_status", "CIMP_status", 
                    "history_colon_polyps"),
  values_not_considered = list("unknown", "unknown", "unknown", "unknown", c("unknown","inconsistency"), "unknown", 
                                "unknown", "unknown"),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_READ.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  new_feature = list(c(old="plate_id", met="less_plate_id", new_name="less_plate_id")),
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/SKCM/SKCM_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "stage", "history_of_other_malignancy"),
  values_not_considered = list("unknown", c("unknown", "NOS"), c("unknown","inconsistency")),
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_SKCM.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  join_by="columns",
  bacteria = "../../bacteria/RNAseq/raw/merged_unamb_score_norm/BRCA/BRCA_selectedTumor_bacteria_species_merged_unamb_score_norm.txt",
  cat_features = c("gender", "stage", "history_of_other_malignancy", "MSI_status"),
  values_not_considered = list("unknown", "unknown", c("unknown","inconsistency"), "unknown"),
  cont_features = c("percent_normal_cells", "age_at_diagnosis", "mutation_burden", "stemness", "aneuploidy_score"),
  taxa_selection = "../../results/contamination/subset_taxa/Presence_more0.1samples_BRCA.txt",
  taxa_selection_approach="intersect",
  database_taxa = "../../bacteria/gold_standard_colon_bacteria_species.txt",
