...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_COAD.txt",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_GBM.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_LUAD.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_LUSC.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_HNSC.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_OV.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_READ.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  cont_features = c("percent_normal_cells", "age", "mutation_burden", "stemness", "aneuploidy_score"),
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_SKCM.txt",
  taxa_selection_approach="intersect",
...
rmarkdown::render("scripts/identification_related_species/taxa_compositions_wilc.Rmd", params=list(
  ...
  heatmap = TRUE,
  taxa_selection = "../../results/filters/subset_taxa/Presence_more0.1samples_BRCA.txt",
  taxa_selection_approach="intersect",
