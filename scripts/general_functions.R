...
# my palettes
my_palettes=list(default="default",
					light_dark_blue_and_gray=c("#494EEB", "#37C6D4", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF"),
					COAD_IEO_rest=c("#D43F3AFF", "#E48B32", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF"),
					COAD_IEO_rest2=c("#3498DB", "#BFBFBF", "#D43F3AFF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF", "#BFBFBF"),
					locuszoom=c("#D43F3AFF", "#EEA236FF", "#5CB85CFF", "#46B8DAFF", "#357EBDFF", "#9632B8FF", "#B8B8B8FF"),
					locuszoom2=c("#D43F3AFF", "#EEA236FF", "#5CB85CFF", "#46B8DAFF", "#357EBDFF", "#9632B8FF", "#B8B8B8FF", "#EE4C97FF"),
					locuszoom3=c("#D35400", "#D43F3AFF", "#EEA236FF", "#5CB85CFF", "#46B8DAFF", "#357EBDFF", "#9632B8FF", "#B8B8B8FF", "#EE4C97FF"),
					locuszoom4=c("#D35400", "#D43F3AFF", "#5CB85CFF", "#46B8DAFF", "#357EBDFF", "#B8B8B8FF", "#EE4C97FF"),
					...
					read_length=c("#008B45FF", "#E6550DFF"),
					startrek=c("#CC0C00FF", "#5C88DAFF", "#84BD00FF", "#FFCD00FF", "#7C878EFF", "#00B5E2FF", "#00AF66FF"),
					...
					uchicago=c("#800000FF", "#767676FF", "#FFA319FF", "#8A9045FF", "#155F83FF", "#C16622FF", "#8F3931FF", "#58593FFF", "#350E20FF"),
