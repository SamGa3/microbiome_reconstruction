...
rmarkdown::render("../../microbes/continuous_metadata_analysis.Rmd", params=list(
  ...
  feature1 = c("mean_ratio_akk_eub_dapi", "mean_ratio_praus_eub_dapi", "mean_ratio_fuso_eub_dapi"),
  feature2 = c("239935", "853", "851"),
  ...
  picture_path = "../../results/comparison/FISH/images/paper_IEO_noNETOnlySelOnlyTumorlist1_correlations_FISH_RNAseq"
), output_file = "../../results/comparison/FISH/paper_IEO_noNETOnlySelOnlyTumorlist1_correlations_FISH_RNAseq_akk_praus_fuso.html")
